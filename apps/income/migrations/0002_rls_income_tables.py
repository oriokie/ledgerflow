...
withheld from it. Nothing here may be readable across a tenant boundary.
"""
...
RLS_TABLES = ["income_incomesource", "income_incomededuction", "income_incomereceipt"]
...
class Migration(migrations.Migration):
    dependencies = [("income", "0001_initial")]
