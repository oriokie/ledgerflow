"""Row-Level Security for the planning profile.

The profile holds a household's FI year and spending override — intent, not
history. Same fail-closed tenant isolation as assumption sets.
"""
...
RLS_TABLES = ["projections_planningprofile"]
...
class Migration(migrations.Migration):
    dependencies = [("projections", "0004_assumptionset_annual_expense_ratio_and_more")]
