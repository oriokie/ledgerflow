"""Row-Level Security for the asset tables.
...
These rows describe what a household owns and what it is worth — the closest
thing the product holds to a statement of wealth. Nothing here may be readable
...
RLS_TABLES = ["assets_asset", "assets_valuation"]
