...
class ReportQuerySerializer(serializers.Serializer):
    ...
    account_ids = serializers.ListField(child=serializers.UUIDField(), required=False, allow_empty=True)
    ...
    def validate(self, attrs):
        ...
        if bool(start) != bool(end):
            ...
            raise serializers.ValidationError("Provide both start and end for a custom range, or neither.")
        ...
        if period == Period.CUSTOM and not start:
            ...
            raise serializers.ValidationError("A custom period needs both a start and an end.")
