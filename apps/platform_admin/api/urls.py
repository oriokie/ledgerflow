...
urlpatterns = [
    ...
    path("currencies/", CurrencyCatalogView.as_view(), name="platform-currencies"),
    path("currencies/<str:code>/", CurrencyCatalogDetailView.as_view(), name="platform-currency-detail"),
    path("currencies/<str:code>/rate/", CurrencyRateView.as_view(), name="platform-currency-rate"),
    path("fx/refresh/", FxRefreshView.as_view(), name="platform-fx-refresh"),
